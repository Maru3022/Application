...
-- Indexes on each partition (PostgreSQL 11+ propagates these automatically)
CREATE INDEX ON sleep_entries (user_id, sleep_start DESC);

-- Migrate existing data
INSERT INTO sleep_entries SELECT * FROM sleep_entries_old;
...
INSERT INTO water_entries SELECT * FROM water_entries_old;
...
INSERT INTO activity_entries SELECT * FROM activity_entries_old;
